...
const (
	spanName           = "gorm"
	callBackBeforeName = "gormTracing:before"
	callBackAfterName  = "gormTracing:after"
...
func (gp *GormTracingPlugin) Name() string {
	return "gormTracingPlugin"
}

func (gp *GormTracingPlugin) Initialize(db *gorm.DB) (err error) {
